 ...
 */
class LibroDetailActivity extends FragmentActivity {
	...
	override onOptionsItemSelected(MenuItem item) {
		switch (item.itemId) {
			case android.R.id.home: this.irADetalle()
	...
	// Hack para que no tire error dos líneas en un switch en xtend
	private def boolean irADetalle() {
